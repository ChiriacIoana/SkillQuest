...
const questTracks: QuestTrack[] = [
{
    ...
    href: '/quests/javascript',
},
{
    id: 'ts',
    title: 'TypeScript Pro',
    description: 'Learn TypeScipt from the ground up and build scalable, type safe applications.',
    difficulty: 'Intermediate',
    xprange: '100-300 XP',
    color: 'from-blue-400 to-indigo-500',
    href: '/quests/typescript',
},
{
    id: 'calc',
    title: 'Calculus Fundamentals',
    description: 'Understand the basics of calculus including limits, derivatives, and integrals.',
    difficulty: 'Advanced',
    xprange: '250-400 XP',
    color: 'from-green-400 to-emerald-500',
    href: '/quests/calculus',
}
];
    ...
    return (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-8">
          Select a learning path below to start your adventure and earn XP as you level up your skills.
        </p>
  ...
  >
    ...
    <CardContent>
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <span className="text-sm text-gray-500 dark:text-gray-400">{track.xprange}</span>
      </div>
      ...
      <div className="mb-2">
        ...
        <div className="w-full bg-gray-200 dark:bg-gray-600 h-2 rounded-full overflow-hidden">
          <motion.div
            ...
            initial={{ width: 0 }}
            animate={{ width: '60%' }} // <-- set dynamically if you track progress
